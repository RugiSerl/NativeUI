...
UICheckbox::UICheckbox(raylib::Rectangle r, Anchor2 a, UIStylebox normalStylebox, UIStylebox selectedStylebox, UIStylebox hoveredStylebox, UIStylebox downStylebox): 
    UIButton(r, a, [this](){value = !value;}, normalStylebox, selectedStylebox, hoveredStylebox, downStylebox),
    value(false) {};
...
void UICheckbox::draw(raylib::Rectangle boundingBox) {
    ...
    if (value) {
        ...
        UIStylebox(0, stylebox.edgeRadius, BLACK, BLACK).draw(raylib::Rectangle(rect.GetSize()*0.67), Anchor2{CENTER, CENTER}, anchoredRect);
    }
}